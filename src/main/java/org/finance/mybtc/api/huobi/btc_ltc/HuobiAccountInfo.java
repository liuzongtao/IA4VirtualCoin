...
public class HuobiAccountInfo {
	 ...
	 */
	private float available_cny_display;
	/**
	 * 可用比特币
	 */
	private float available_btc_display;
	/**
	 * 可用莱特币（只有人民币交易市场才会返回）
	 */
	private float available_ltc_display;
	/**
	 * 冻结人民币（美元交易市场返回frozen_usd_display）
	 */
	private float frozen_cny_display;
	/**
	 * 冻结比特币
	 */
	private float frozen_btc_display;
	/**
	 * 冻结莱特币（只有人民币交易市场才会返回）
	 */
	private float frozen_ltc_display;
	/**
	 * 申请人民币数量（美元交易市场返回loan_usd_display）
	 */
	private float loan_cny_display;
	/**
	 * 申请比特币数量
	 */
	private float loan_btc_display;
	/**
	 * 申请莱特币数量（只有人民币交易市场才会返回）
	 */
	private float loan_ltc_display;
	 ...
	 */
	public void setNet_asset(float net_asset) {
	 ...
	 */
	public float getAvailable_cny_display() {
	 ...
	 */
	public void setAvailable_cny_display(float available_cny_display) {
	 ...
	 */
	public float getAvailable_btc_display() {
	 ...
	 */
	public void setAvailable_btc_display(float available_btc_display) {
	 ...
	 */
	public float getAvailable_ltc_display() {
	 ...
	 */
	public void setAvailable_ltc_display(float available_ltc_display) {
	 ...
	 */
	public float getFrozen_cny_display() {
	 ...
	 */
	public void setFrozen_cny_display(float frozen_cny_display) {
	 ...
	 */
	public float getFrozen_btc_display() {
	 ...
	 */
	public void setFrozen_btc_display(float frozen_btc_display) {
	 ...
	 */
	public float getFrozen_ltc_display() {
	 ...
	 */
	public void setFrozen_ltc_display(float frozen_ltc_display) {
	 ...
	 */
	public float getLoan_cny_display() {
	 ...
	 */
	public void setLoan_cny_display(float loan_cny_display) {
	 ...
	 */
	public float getLoan_btc_display() {
	 ...
	 */
	public void setLoan_btc_display(float loan_btc_display) {
	 ...
	 */
	public float getLoan_ltc_display() {
	 ...
	 */
	public void setLoan_ltc_display(float loan_ltc_display) {
