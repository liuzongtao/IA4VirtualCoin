package org.finance.mybtc.api.okCoin.stock.impl;
...
import org.finance.mybtc.api.okCoin.HttpUtilManager;
import org.finance.mybtc.api.okCoin.MD5Util;
import org.finance.mybtc.api.okCoin.StringUtil;
import org.finance.mybtc.api.okCoin.stock.IStockRestApi;

public class StockRestApi implements IStockRestApi {

	public static final String URL = "https://www.okcoin.cn";
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.finance.mybtc.api.okCoin.stock.IStockRestApi#withdraw(java.lang.
	 * String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public String withdraw(String symbol,String withdraw_amount,String chargefee, String trade_pwd, String withdraw_address)
			throws HttpException, IOException {
		// 构造参数签名
		Map<String, String> params = new HashMap<String, String>();
		params.put("api_key", api_key);
