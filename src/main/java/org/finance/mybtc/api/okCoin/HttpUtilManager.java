...
public class HttpUtilManager {
	...
	private String baseRequestHttpGet(String url_prex, String url, String param) throws HttpException, IOException {
	...
	public String requestHttpGet(String url_prex, String url, String param) {
		...
		for (int i = 0; i < 10; i++) {
			try {
				responseData = baseRequestHttpGet(url_prex, url, param);
				break;
			} catch (Exception e) {
	...
	public String requestHttpPost(String url_prex, String url, Map<String, String> params) {
		...
		for (int i = 0; i < 10; i++) {
			try {
				responseData = baseRequestHttpPost(url_prex, url, params);
				break;
			} catch (Exception e) {
				log.error(e.getMessage());
			}
	...
	private String baseRequestHttpPost(String url_prex, String url, Map<String, String> params)
