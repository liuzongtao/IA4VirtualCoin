...
public class Btc_EthChangeImpl extends AOkcoinChange {
	...
	public ChangeInfo execExchange() {
		...
		String okcoinWithdrawAdd = Configs.API_CONFIG_OKCOIN.getWithdraw_addr_eth();

		ChangeInfo info = baseExecExchange(okcoinCny, okcoinBtc, bitfinexBtc, bitfinexEth, okcoinEth, okcoinWithdrawAdd,
				bitfinexWithdrawAdd);
